...
st.markdown(
    ...
    "🟢 <b>추가 매수 가능</b> — 단기(50일) 평균선이 장기(200일) 평균선 위에 있는 상승 추세. 분할 매수를 검토할 수 있는 구간 &nbsp;·&nbsp; "
    "🔵 <b>보유</b> — 특이 신호 없음. 현재 추세 유지 중 &nbsp;·&nbsp; "
    "🟠 <b>주의</b> — 하락 추세이거나, 단기 과열(RSI 70+)이거나, 매수가 대비 -8% 이상 손실. 대응 준비 필요 &nbsp;·&nbsp; "
    "🔴 <b>매도 검토</b> — 단기선이 장기선 아래로 내려간 하락 전환, 극단 과열(RSI 80+), 또는 매수가 대비 -20% 이상 손실 중 하나 해당. 매도 여부 판단 필요"
    "</small>",
