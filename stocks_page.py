...
- **타이밍**: 52주 고가 근접도 (George-Hwang 2004). "현재가 / 52주 최고가 비율 — 신고가 근접일수록 강세 지속 가능성↑"

**🚦 타이밍 라벨 (점수 옆에 표시)**
- 🔴 **너무 올라 위험**: 52주 고가 97%+ (단기 정점 부근, George-Hwang 2004) — 분할매수 권장
...
- **점수는 종목 후보 압축 도구**. 최종 결정은 본인 판단 + 공식 공시 확인.
    ...
    st.dataframe(
        rank_table[["순위", "티커", "종목명", "통합 추천", "모멘텀", "타이밍", "우선순위 점수",
                    "종합 점수", "추세", "판정",
                    "저평가", "품질", "성장", "12-1M 모멘텀", "52주 근접도",
                    "종가", "PER", "PBR", "ROE(%)",
...
| QVM | Q1 모멘텀 상위25% | Q2 중상위 | Q3 중하위 | Q4 하위25% |
|---|---|---|---|---|
| **≥0.5** 좋은 종목 | 💎 지금이 기회 | ✅ 계속 모아도 좋음 | ⏳ 모멘텀 개선 대기 | 🟠 신중 매수 |
| **0 근방** 평범 | 🔵 모멘텀만 강함 | ⚪ 관망 | ⚪ 관망 | ⚪ 관망 |
