...
| **코인(G1·G2 알트)** | 개별손실 손절선 -40% 이내 회복 또는 2027년말 데드라인 (`scripts/crypto_analysis.py::coin_alt_stoploss_status()`) | 19종목·10,940건 골든크로스 진입 케이스에 `scripts/backtest.py::backtest_loss_cut()`을 -20/-30/-40/-50/-60/-70% 각각 적용 — better_to_cut 비율이 -20%(74.3%)→-40%(70.2%)까지는 탄탄하다가 -60%(42.9%, 동전던지기보다 나쁨)에서 무너짐. 그래서 -40%를 "조기 손절선"으로 채택하되, 이미 그보다 훨씬 깊이 물린 기존 보유분은 즉시 매도 대신 회복/데드라인 대기. G3(BTC·ETH·SOL)는 핵심 장기보유라 제외 — 2026-07-22 |
